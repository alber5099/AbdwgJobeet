 ...
 * Time: 下午 5:42
 */
// src\Abdwg\JobeetBundle\Tests\Controller\ApiControllerTest.php
...
class ApiControllerTest extends WebTestCase
{
    ...
    public function testList()
    {
        ...
        $this->assertEquals('Abdwg\JobeetBundle\Controller\ApiController::listAction', $client->getRequest()->attributes->get('_controller'));
