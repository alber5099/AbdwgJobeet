 ...
 * Time: 上午 11:44
 */
// src\Abdwg\JobeetBundle\Tests\Controller\CategoryControllerTest.php
...
class CategoryControllerTest extends WebTestCase
{
    ...
    public function testShow()
    {
        ...
        $categories = $this->em->getRepository('AbdwgJobeetBundle:Category')->getWithJobs();
        ...
        foreach($categories as $category) {
            ...
            $this->assertEquals('Abdwg\JobeetBundle\Controller\CategoryController::showAction', $client->getRequest()->attributes->get('_controller'));
            $this->assertEquals($category->getSlug(), $client->getRequest()->attributes->get('slug'));

            $jobs_no = $this->em->getRepository('AbdwgJobeetBundle:Job')->countActiveJobs($category->getId());
