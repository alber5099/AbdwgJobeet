 ...
 * Time: 下午 6:57
 */
// src\Abdwg\JobeetBundle\Admin\AffiliateAdmin.php
namespace Abdwg\JobeetBundle\Admin;
...
class AffiliateAdmin extends Admin
{
    ...
    protected function configureListFields(ListMapper $listMapper)
    {
        $listMapper
            ...
            ->add('created_at')
            ->add('token')
            ->add('_action', 'actions', array( 'actions' => array('activate' => array('template' => 'AbdwgJobeetBundle:AffiliateAdmin:list__action_activate.html.twig'),
                    'deactivate' => array('template' => 'AbdwgJobeetBundle:AffiliateAdmin:list__action_deactivate.html.twig'))))
