 ...
 * Time: 下午 7:04
 */
// src\Abdwg\JobeetBundle\Controller\AffiliateAdminController.php
...
class AffiliateAdminController extends Controller
{
        ...
        try {
            foreach($selectedModels as $selectedModel) {
                ...
                $message = \Swift_Message::newInstance()
                    ...
                    ->setFrom('contact@abdwg.com')
                    ->setTo($selectedModel->getEmail())
                    ->setBody(
                        $this->renderView('AbdwgJobeetBundle:Affiliate:email.txt.twig', array('affiliate' => $selectedModel->getToken())))
                ;
    ...
    public function activateAction($id)
    {
        ...
        $affiliate = $em->getRepository('AbdwgJobeetBundle:Affiliate')->findOneById($id);
        ...
        try {
            ...
            $message = \Swift_Message::newInstance()
                ...
                ->setBody(
                    $this->renderView('AbdwgJobeetBundle:Affiliate:email.txt.twig', array('affiliate' => $affiliate->getToken())))
            ;
